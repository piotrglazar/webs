...
public class LoanFactoryTest {
    ...
    public void shouldCreateLoan() {
        ...
        given(loanCalculator.calculateLoan(form.getAmountLoaned(), form.getLoanOption())).willReturn(new BigDecimal("10"));
        ...
        // then
        assertThat(loan.getAmountRemaining()).isEqualByComparingTo("110");
